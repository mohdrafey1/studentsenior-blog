    ...
    return (
        ...
        >
            ...
            <input
                ...
                className={`ml-2 w-full text-sm text-gray-900 placeholder-gray-400 bg-transparent outline-none font-inter`}
        ...
        <header className='bg-gray-50 border-b border-gray-200 w-full px-4 sm:px-8 md:px-16 py-2 sticky top-0 z-50'>
            <div className='w-full flex flex-row items-center justify-between px-4 sm:px-8 md:px-16'>
                ...
                <Link href='/' className='flex items-center gap-0 shrink-0'>
                    ...
                    />
                    <span
                        className={`font-poppins text-xl sm:text-2xl text-gray-900 font-semibold`}
                    >
                        Blogs
                    </span>
                </Link>
